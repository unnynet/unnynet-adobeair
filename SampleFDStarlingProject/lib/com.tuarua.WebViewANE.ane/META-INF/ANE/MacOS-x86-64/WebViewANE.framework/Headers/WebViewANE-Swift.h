...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WebViewANE",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface SwiftController (SWIFT_EXTENSION(WebViewANE)) <WKScriptMessageHandler>
...
@interface SwiftController (SWIFT_EXTENSION(WebViewANE)) <WKUIDelegate>
...
@interface SwiftController (SWIFT_EXTENSION(WebViewANE)) <NSURLSessionDownloadDelegate>
...
@interface SwiftController (SWIFT_EXTENSION(WebViewANE))
...
@interface SwiftController (SWIFT_EXTENSION(WebViewANE)) <WKNavigationDelegate>
