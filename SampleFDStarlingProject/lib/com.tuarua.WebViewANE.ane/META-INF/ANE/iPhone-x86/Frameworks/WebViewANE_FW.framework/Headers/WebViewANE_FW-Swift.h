...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WebViewANE_FW",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC13WebViewANE_FW13Configuration")
...
@interface SwiftController (SWIFT_EXTENSION(WebViewANE_FW)) <WKUIDelegate>
@end

@class WKUserContentController;
@class WKScriptMessage;

@interface SwiftController (SWIFT_EXTENSION(WebViewANE_FW)) <WKScriptMessageHandler>
...
@interface SwiftController (SWIFT_EXTENSION(WebViewANE_FW)) <WKNavigationDelegate>
...
@interface SwiftController (SWIFT_EXTENSION(WebViewANE_FW))
